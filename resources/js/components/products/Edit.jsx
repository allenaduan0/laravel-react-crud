                ...
                <div className='card_wrapper'>
                        <div className='wrapper_left'>
                            <div className='card'>
                                ...
                                <textarea cols='10' row='5' value={description} onChange={(event)=>{setDescription(event.target.value)}}></textarea>
                                    ...
                                    <ul className='images_list'>
                                        ...
                                        <li className='image_item'>
                                            <form className='image_item-form'>
                                                <label className='image_item-form--label'>Edit Image</label>
